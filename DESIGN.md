...
- **页脚**:大区块(品牌 + 产品 tagline「聊一句，就有一张表单。」+ 链接)+ 最底部 bar(版权 `© 2026 阿空智能` + 备案号居中)。**「无 slogan」只约束底栏** —— 底栏删掉 agentaily 集团 slogan(`AGENTAILY · 聊天×万物`)那条、只留法务行;**大区块品牌字样下的产品 tagline 保留**(Mec6 快照 `sections2.jsx:88` 有它)。继承 agentaily 官网定稿的页脚规则。
...
| **页脚 (Footer)**                                     | 品牌 + 产品 tagline / 链接 + 底栏版权/备案号居中(无集团 slogan) | ✅ 已对齐 v1                       |
